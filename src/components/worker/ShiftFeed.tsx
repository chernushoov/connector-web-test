...
const mockShifts: ShiftPosting[] = [
  {
    ...
    description: 'Loading and unloading goods, organizing inventory',
    employer: {
      id: 'emp1',
      name: 'Alex Cohen',
    ...
    location: { latitude: 32.0853, longitude: 34.7818, address: 'Tel Aviv Port', distance: 2.3 },
    city: 'Tel Aviv',
    date: new Date(),
    startTime: '08:00',
    endTime: '16:00',
  ...
  },
  {
    ...
    description: 'Help with apartment moving, furniture assembly',
    employer: {
      id: 'emp2',
      name: 'David Levi',
      company: 'QuickMove',
    ...
    location: { latitude: 32.0753, longitude: 34.7918, address: 'Ramat Gan', distance: 5.1 },
    city: 'Ramat Gan',
    ...
    requiredSkills: ['moving', 'lifting', 'driving'],
    status: 'open',
    isInstant: false,
    acceptsTeams: true,
    hasEscrow: true,
  ...
  },
  {
    ...
    description: 'Setting up chairs, tables, and equipment for corporate event',
    employer: {
      id: 'emp3',
      name: 'Marina Events',
    ...
    location: { latitude: 32.1053, longitude: 34.8018, address: 'Herzliya Pituach', distance: 8.7 },
    city: 'Herzliya',
    ...
    requiredSkills: ['events', 'physical'],
    status: 'open',
    isInstant: false,
    acceptsTeams: true,
    hasEscrow: true,
